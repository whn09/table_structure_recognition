...
# yolo detect train data=data/custom-structure-all.yaml model=yolov8x.pt name=yolov8x-custom-structure-all imgsz=1024 epochs=10 device=0,1,2,3,4,5,6,7 workers=32 batch=128
