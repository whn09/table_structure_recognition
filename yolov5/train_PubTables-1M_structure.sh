...
# yolo detect val split=test data=data/custom-structure.yaml weights=runs/detect/yolov5s-custom-structure/weights/best.pt imgsz=1024 epochs=10 device=0,1,2,3,4,5,6,7 workers=96 batch=1024